...
def CalcFeatures(image, segmentation, parameters, output,
    ...
    panda_labels = ['image_type', 'gabor_settings', 'image_features',
    ...
    image_features, image_features_array =\
        gf.get_image_features(image_data, contours,
                              gabor_settings, 0, False, config["ImageFeatures"], output)

    panda_data = pd.Series([image_type, gabor_settings, image_features,
                            image_features_array],
                           index=panda_labels,
                           name='Image features'
                           )
