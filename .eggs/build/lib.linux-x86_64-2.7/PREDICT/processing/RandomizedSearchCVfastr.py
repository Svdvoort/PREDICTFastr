...
class BaseSearchCVfastr(six.with_metaclass(ABCMeta, BaseEstimator,
                        MetaEstimatorMixin)):
    ...
    def _fit(self, X, y, groups, parameter_iterable):
        ...
        estimator_data = pd.Series([base_estimator, X, y, self.scorer_,
                                    self.verbose,
        ...
        network.execute(source_data, sink_data, tmpdir=os.path.join(tempfolder, 'GS', name, 'tmp'))
