...
import csv
import os
import PREDICT.plotting.plot_images as pi
import SimpleITK as sitk
from PREDICT.addexceptions import PREDICTKeyError
import zipfile
...
def plot_ranked_images(pinfo, label_type, images, segmentations, ranked_truths,
    ...
    for pid in ranked_PIDs:
        if pid in PIDs_images:
            ...
            print('[PREDICT Warning] Patient {} not in images list!').format(str(pid))
