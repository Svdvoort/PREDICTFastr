...
def plot_single_SVR(prediction, mutation_data, label_type, survival=False,
...
def main():
    if len(sys.argv) == 1:
        ...
        mutation_data = '/home/martijn/git/RadTools/CLM_MICCAI/pinfo_CLM_MICCAI_test_months.txt'
        label_type = 'KM'
        survival = True
    elif len(sys.argv) != 3:
        ...
        mutation_data = sys.argv[2]
    plot_single_SVR(prediction, mutation_data, label_type, survival)
