...
class BaseSearchCVJoblib(six.with_metaclass(ABCMeta, BaseEstimator,
    ...
    def _fit(self, X, y, groups, parameter_iterable):
        ...
        (save_data, GroupSel, VarSel, feature_labels, scalers) = zip(*out)
        ...
        # TODO: RandomizedSearchCV uses the best found parameters in the predict function.
        # Hence we should make sure we store both all Var and GroupSels in a separate field/ or keepthem in the cv_results.
        # Next, we should modify the BaseEstimator predict function to also use these feature selectors
        # if available plus the scaler. Also edit this in the crossval function. Ideally, we make this a general approach with only one object.
        ...
        results['VarSel'] = VarSel
        results['GroupSel'] = GroupSel
