...
def main():
    ...
    (ret, GroupSel, VarSel, SelectModel, feature_labels, scaler, imputer, pca) = zip(*out)

    source_labels = ['RET', 'feature_labels', 'scaler', 'VarSelection', 'GroupSelection', 'SelectModel', 'Imputer', 'PCA']

    source_data =\
        pd.Series([ret, feature_labels, scaler, VarSel, GroupSel, SelectModel, imputer, pca],
                  index=source_labels,
